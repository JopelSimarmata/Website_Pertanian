      ...
      <div class="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden flex flex-col h-full">
        ...
        <div class="p-6 flex flex-col justify-between flex-1">
          <div>
            ...
            <p class="mt-2 text-sm text-gray-500">{{ \Illuminate\Support\Str::limit($product->description ?? '-', 120) }}</p>
            ...
            <div class="mt-4 flex items-center text-sm text-gray-600 gap-4">
              <div class="flex items-center gap-2">
                ...
                <span class="text-sm">{{ $product->rating ?? '4.5' }}</span>
              ...
              <div class="flex items-center gap-2">
                ...
                <span class="text-gray-600">{{ $product->location ?? 'Lokasi tidak tersedia' }}</span>
              </div>
            </div>
          </div>
          ...
          <div class="mt-4">
            <div class="rounded-lg border border-emerald-100 bg-emerald-50 p-3 text-emerald-800 text-sm min-h-[72px]">
              ...
              <div class="text-lg font-bold mt-1">Rp {{ number_format($product->price, 0, ',', '.') }} / {{ $product->unit ?? 'kg' }}</div>
