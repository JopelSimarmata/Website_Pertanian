  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form action="#" method="POST" class="space-y-1">
      <div class="mt-2">
        ...
        <div class="mt-2">
          <input id="name" type="name" name="name" required autocomplete="name" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"  value="{{ old('name') }}>
        </div>
      </div>
    ...
    <p class="mt-10 text-center text-sm/6 text-gray-500">
      Sudah punya akun?
      <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500">Masuk sekarang</a>
    </p>
  </div>
</div>
</x-layout>