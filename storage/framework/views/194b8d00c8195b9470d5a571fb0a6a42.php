            ...
            <div class="relative overflow-hidden rounded-3xl shadow-2xl h-72 md:h-80 lg:h-96">
                <div id="slider" class="flex h-full transition-transform duration-700">
                    ...
                    <div class="min-w-full h-full">
                        <img src="<?php echo e(asset('image/farm.jpg')); ?>" class="w-full h-full object-cover rounded-3xl">
                    </div>

                    <div class="min-w-full h-full">
                        <img src="<?php echo e(asset('image/farm2.jpg')); ?>" class="w-full h-full object-cover rounded-3xl">
                    </div>

                    <div class="min-w-full h-full">
                        <img src="<?php echo e(asset('image/farm3.jpg')); ?>" class="w-full h-full object-cover rounded-3xl">
                    </div>
    ...
    <div class="max-w-7xl mx-auto grid md:grid-cols-4 gap-8 px-6">
        ...
        <div>
            <div class="flex items-center gap-3">
                <img src="<?php echo e(asset('image/logo.png')); ?>" class="h-10 w-auto">
...
<?php endif; ?>
<?php /**PATH C:\Users\asus3\Downloads\projext papwe\Website_Pertanian\resources\views/pages/home.blade.php ENDPATH**/ ?>